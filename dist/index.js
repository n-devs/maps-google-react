(function (global, factory) {
  ...
  var GoogleMapApis = exports.GoogleMapApis = function GoogleMapApis(input) {
    return function (GoogleMapApiComponent) {
      var GoogleMapApi = function (_React$Component) {
        _inherits(GoogleMapApi, _React$Component);

        function GoogleMapApi(props, context) {
          _classCallCheck(this, GoogleMapApi);

          // Build options from input
          var _this = _possibleConstructorReturn(this, (GoogleMapApi.__proto__ || Object.getPrototypeOf(GoogleMapApi)).call(this, props, context));
        ...
        _createClass(GoogleMapApi, [{
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(GoogleMapApiComponent, props),
